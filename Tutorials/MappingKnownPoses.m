...
% Enable ROS interface for the simulator. The simulator creates and
% subscribes to send and recieve data over ROS.
enableROSInterface(sim, true);

% Increase the laser sensor resolution in the simulator to facilitate map
% building
...
while( distanceToGoal > goalRadius)
    ...
    % Computer the linear and angular velocity of the robot and publish it
    % to drive the robot
